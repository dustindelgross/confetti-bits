...
add_action( 'cb_init', 'cb_setup_title', 8 );
add_action( 'cb_init', 'cb_add_rewrite_tags', 9 );
add_action( 'cb_init', 'cb_add_rewrite_rules', 10 );
add_action( 'cb_init', 'cb_add_permastructs', 11 );
//add_action( 'cb_init', 'cb_setup_rest_api', 12 );
