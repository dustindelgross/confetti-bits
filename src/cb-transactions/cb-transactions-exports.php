...
/**
 * CB Export Transaction History for User
 * 
 ...
 */
function cb_get_transaction_history_for_user( $user_id = 0, $export_type = '' ) {
...
function cb_export() {
	...
	cb_get_transaction_history_for_user( $user_id, $export_type );
}
